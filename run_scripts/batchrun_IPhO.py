...
ARGS_LIST = [
    *[{
        ...
        "tools_list": ["ask_image_expert", "finalize_part_answer", "ask_review_expert"],
        "input_markdown_file": "examples/Problems/IPhO25/theory1/theory1.md",
        "output_file_position": f"output/IPhO2025/theory1/theory1_{idx}.md",
    ...
    *[{
        ...
        "output_file_position": f"output/IPhO2025/theory2/theory2_{idx}.md",
    } for idx in range(NUM_PER_QUESTION)],
    *[{
        "manager_model": "openrouter/google/gemini-2.5-pro",
        "image_tool_model": "openrouter/google/gemini-2.5-pro",
        ...
        "output_file_position": f"output/IPhO2025/theory3/theory3_{idx}.md",
    } for idx in range(NUM_PER_QUESTION)],
]
